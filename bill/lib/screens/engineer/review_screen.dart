...
class ReviewScreen extends StatefulWidget {
  ...
  const ReviewScreen({super.key, this.status});
...
class _ReviewScreenState extends State<ReviewScreen> {
  ...
  Future<void> _verifyExpense(String expenseId, bool isVerified, String comment) async {
    try {
      final expenseProvider = context.read<ExpenseProvider>();
      
      if (isVerified) {
        await expenseProvider.verifyExpense(expenseId, comment);
      } else {
        await expenseProvider.rejectExpense(expenseId, comment);
      }
      
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(isVerified ? 'Expense verified successfully' : 'Expense marked for revision'),
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text('Amount: ${CurrencyFormatter.formatINR(expense.totalAmount)}'),
                Text('User: ${expense.userName}'),
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                ...
                _verifyExpense(expense.id, isVerified, commentController.text.trim());
              },
              child: Text(isVerified ? 'Verify' : 'Request Revision'),
            ),
          ],
        ),
      ),
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  _FilterChip(
                    label: 'Verified',
                    isSelected: _selectedStatus == 'verified',
                    onSelected: () {
                      setState(() {
                  ...
                  _FilterChip(
                    label: 'Under Review',
                    isSelected: _selectedStatus == 'under_review',
                    onSelected: () {
                      setState(() {
            ...
            child: Consumer<ExpenseProvider>(
              builder: (context, expenseProvider, _) {
                ...
                return RefreshIndicator(
                  onRefresh: () async {
                    await expenseProvider.loadEngineerExpenses();
                    _applyFilters();
                  },
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _ReviewExpenseCard(
                        expense: expense,
                        onTap: () => context.push('/engineer/review/${expense.id}'),
                        onReview: expense.status == 'submitted' 
                          ? () => _showReviewDialog(expense)
                          : null,
                      );
                    },
                  ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Assigned expenses will appear here for review',
            style: TextStyle(
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) {
                    setDialogState(() {
                      _selectedStatus = value ?? 'submitted';
                    });
                  },
                ),
              ],
...
class _ReviewExpenseCard extends StatelessWidget {
  final ExpenseModel expense;
  final VoidCallback onTap;
  final VoidCallback? onReview;

  const _ReviewExpenseCard({
